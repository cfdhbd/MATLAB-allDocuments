...
% netexist = hasVariable(workspace,'net6');
% 
% if netexist == 0
...
% else
%     net1 = getVariable(workspace,'net1');
%     net2 = getVariable(workspace,'net2');
%     net3 = getVariable(workspace,'net3');
%     net4 = getVariable(workspace,'net4');
%     net5 = getVariable(workspace,'net5');
%     net6 = getVariable(workspace,'net6');
%     
% end
end
